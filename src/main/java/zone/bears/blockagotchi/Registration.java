...
//  private static final DeferredRegister<ModDimension> DIMENSIONS = DeferredRegister.create(ForgeRegistries.MOD_DIMENSIONS, MODID);
    ...
    public static final RegistryObject<TileEntityType<WatchTile>> watch_tile = TILES.register("watch_tile", () -> TileEntityType.Builder.of(WatchTile::new, watch_block.get()).build(null));
